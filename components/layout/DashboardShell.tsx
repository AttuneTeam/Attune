    ...
    <div className="flex h-screen overflow-hidden bg-background">
      ...
      {!chatOpen && (
        <button
          ...
          className="fixed bottom-6 right-6 z-40 flex items-center gap-2 px-4 py-2.5 rounded-full transition-shadow hover:shadow-lg backdrop-blur-xl border bg-white/70 border-[rgba(65,108,99,0.15)] dark:bg-white/10 dark:border-white/15 text-[var(--color-primary)] dark:text-white/80"
          style={{
