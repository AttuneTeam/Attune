  ...
  try {
    ...
    const { object } = await generateObject({
      ...
      schema: z.object({
        ...
        spofs: z.array(z.object({
          member: z.string().describe('Person who is the single point of failure'),
        ...
        overlaps: z.array(z.object({
          ...
          note: z.string().describe('Whether this is healthy redundancy or unclear ownership'),
